...
<head>
    ...
    <style>
        /* ============================================
           AMAZON GEST PRO — DESIGN SYSTEM v6.0 PREMIUM
           Reescrito do zero — mesmas variáveis e classes
           ============================================ */
        ...
        *, *::before, *::after {
        ...
        :root {
            ...
            --card-hover: rgba(28, 38, 60, 0.92);
            --card-light: rgba(36, 48, 72, 0.85);

            /* Texto */
            --text-color: #e6edf6;
            --text-light: #ffffff;
            --text-muted: #94a3b8;
            --text-contrast: #64748b;
            ...
            --gradient-ia:      linear-gradient(135deg, #a78bfa 0%, #8b5cf6 100%);
            --gradient-card:    linear-gradient(135deg, rgba(28,38,60,0.9), rgba(20,28,45,0.85));
            --gradient-hero:    radial-gradient(circle at 20% 0%, rgba(99,102,241,0.18), transparent 55%),
                                radial-gradient(circle at 80% 100%, rgba(56,189,248,0.18), transparent 55%);

            /* Sombras */
            --shadow:        0 4px 16px rgba(0,0,0,0.35);
            --shadow-hover:  0 14px 40px rgba(0,0,0,0.5);
            --shadow-glow:   0 0 40px -10px rgba(56,189,248,0.4);
            --shadow-soft:   0 4px 20px rgba(0,0,0,0.25);
            --shadow-elegant:0 20px 50px -20px rgba(0,0,0,0.6);
        ...
        body {
            ...
            background-image:
                ...
                radial-gradient(ellipse 60% 40% at 100% 100%, rgba(56,189,248,0.12) 0%, transparent 60%);
        ...
        .sidebar {
            width: 280px;
            background: linear-gradient(180deg, var(--darker-bg) 0%, var(--darkest-bg) 100%);
            padding: 24px 0 20px;
            position: fixed;
            inset: 0 auto 0 0;
            overflow-y: auto;
        ...
        .sidebar .sidebar-toggle:hover { transform: scale(1.1) rotate(180deg); }
        ...
        body.sidebar-collapsed .sidebar-status { display: none; }
        body.sidebar-collapsed .logo { justify-content: center; }
        body.sidebar-collapsed .menu-link { justify-content: center; padding: 14px 0; }
        ...
        .menu { list-style: none; padding: 8px 14px; }
        ...
        .menu-link:hover { color: var(--text-light); background: rgba(255,255,255,0.04); transform: translateX(2px); }
        .menu-link.active {
            color: #fff;
            background: linear-gradient(90deg, rgba(56,189,248,0.18), rgba(99,102,241,0.05));
        ...
        .sidebar-status {
            margin: 24px 18px 0; padding: 16px;
        ...
        .user-info { display: flex; align-items: center; gap: 14px; flex: 1; justify-content: flex-end; }
        .search-container { display: flex; gap: 8px; flex: 1; max-width: 520px; }
        .search-bar {
        ...
        .search-bar:focus-within { border-color: var(--primary-color); box-shadow: 0 0 0 3px rgba(56,189,248,.15); }
        .search-bar i { color: var(--text-muted); }
        .search-bar input {
            flex: 1; background: transparent; border: none; outline: none;
            color: var(--text-light); font-size: 13.5px;
        }
        .search-bar input::placeholder { color: var(--text-contrast); }
        ...
        .search-advanced-btn:hover { color: var(--primary-color); border-color: var(--primary-color); }
        ...
        .card-change.negative, .card-trend.negative {
            background: rgba(248,113,113,.12); color: var(--danger-color);
        }
        .card-top-bar {
        ...
        .card-sparkline { margin-top: 10px; height: 40px; }
        ...
        .tabs-content > .tab-pane { padding: 20px; }
        ...
        .btn-warning  { background: var(--gradient-warning); color: #1a1a1a; }
        .btn-danger   { background: var(--gradient-danger); color: #fff; }
        .btn-ia       { background: var(--gradient-ia); color: #fff; }
        .btn-secondary{
            background: rgba(255,255,255,0.04);
            border-color: var(--border-light);
            color: var(--text-light);
        }
        .btn-secondary:hover { background: rgba(255,255,255,0.08); border-color: var(--primary-color); }
        .btn-small { padding: 6px 12px; font-size: 12px; border-radius: 8px; }
        .btn-full { width: 100%; }
        .btn-group { display: inline-flex; gap: 8px; flex-wrap: wrap; }
        .btn-hero-gradient { background: var(--gradient-primary); color: #fff; padding: 12px 24px; border-radius: 12px; box-shadow: var(--shadow-glow); }
        .btn-hero-outline {
            background: rgba(255,255,255,0.04);
        ...
        input::placeholder, textarea::placeholder { color: var(--text-contrast); }
        ...
        /* ============= TABLES ============= */
        .table-wrap, .table-container { overflow-x: auto; border-radius: var(--radius); }
        table {
            width: 100%;
        ...
        .compact-table tbody td { padding: 8px 12px; font-size: 12.5px; }
        ...
        .status-entregue, .status.entregue   { background: rgba(52,211,153,.12); color: var(--entregue-color); border-color: rgba(52,211,153,.3); }
        .status-pendente, .status.pendente   { background: rgba(251,191,36,.12); color: var(--pendente-color); border-color: rgba(251,191,36,.3); }
        .status-atrasado, .status.atrasado   { background: rgba(248,113,113,.12); color: var(--atrasado-color); border-color: rgba(248,113,113,.3); }
        .status-processando, .status.processando { background: rgba(96,165,250,.12); color: var(--processando-color); border-color: rgba(96,165,250,.3); }
        .status-transito, .status.transito   { background: rgba(56,189,248,.12); color: var(--transito-color); border-color: rgba(56,189,248,.3); }
        ...
        .hero-premium::before { background: var(--primary-color); top: -120px; left: -100px; animation: float-slow 8s ease-in-out infinite; }
        .hero-premium::after  { background: var(--secondary-color); bottom: -120px; right: -80px; animation: float-slow 10s ease-in-out infinite reverse; }
        .hero-premium > * { position: relative; z-index: 1; }
        .hero-greeting { font-size: 13px; color: var(--primary-glow); font-weight: 600; letter-spacing: .5px; text-transform: uppercase; }
        .hero-title    { font-size: 32px; font-weight: 800; color: var(--text-light); margin: 6px 0 4px; letter-spacing: -1px; }
        .hero-subtitle { font-size: 15px; color: var(--text-muted); }
    ...
    <script>
        ...
        class MarketManager {
            ...
            async init() {
                ...
                // Atualizar saudação do hero a cada minuto (igual useEffect do React)
                setInterval(() => {
                    ...
                    <div id="cliente" class="modal-tab-content active">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pedido-cliente-cpf" placeholder="000.000.000-00" required>
                            </div>
                        </div>
...
`;
            ...
            verificarAlertas() {
                ...
                if (document.getElementById('alerta-estoque-baixo')?.checked) {
                    const produtosBaixo = this.produtos.filter(p => {
                        const minimo = Number(p.estoqueMinimo) > 0 ? Number(p.estoqueMinimo) : 5;
                        return Number(p.estoque || 0) <= minimo;
                    });
