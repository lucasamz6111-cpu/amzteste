...
function carregarVersaoSistema() {
    ...
    $versao = 'N/D';
    $atualizado = 'não disponível';
    if (file_exists($packageFile)) {
        $json = json_decode(file_get_contents($packageFile), true);
        if (!empty($json['version'])) {
            $versao = $json['version'];
        }
        $atualizado = date('d/m/Y H:i:s', filemtime($packageFile));
    }
    return ['versao' => $versao, 'atualizado' => $atualizado];
}

$versaoSistema = carregarVersaoSistema();
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .card-kpi {
            overflow: hidden;
            background: linear-gradient(135deg, rgba(20, 32, 55, 0.98), rgba(12, 21, 40, 0.96));
        ...
        .card-kpi:hover .card-icon-square {
        ...
        /* Estilos específicos para CPF/CNPJ */
        #pedido-cliente-cpf {
        ...
        #cpf-feedback .invalido {
            color: #e74c3c;
        }

        #cpf-feedback .pendente {
            color: #95a5a6;
        }
        ...
        /* Abas do Modal Produto */
        .modal-tab-content-produto {
            display: none;
        }

        .modal-tab-content-produto.active {
            display: block;
            animation: fadeIn 0.4s;
        }

        /* Seção organizada para Cliente */
        .secao-cliente {
            display: grid;
        ...
        .secao-cliente .form-group.full-width {
            grid-column: 1 / -1;
        }

        .sub-secao {
            background: linear-gradient(145deg, rgba(0, 168, 255, 0.05), rgba(0, 255, 136, 0.05));
        ...
        /* Organização das abas com indicadores visuais */
        .aba-indicador {
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        @media (max-width: 768px) {
            ...
            /* Responsivo para Sidepanel em telas pequenas */
            .sidepanel {
                width: 85vw;
                right: -85vw;
            }
...
<body>
    <div class="update-banner">
        ...
        <div>Versão do sistema: <?php echo htmlspecialchars($versaoSistema['versao'], ENT_QUOTES, 'UTF-8'); ?></div>
        <div>Última atualização: <?php echo htmlspecialchars($versaoSistema['atualizado'], ENT_QUOTES, 'UTF-8'); ?></div>
        <div style="margin-top:8px; color:#2a4bb5;">Use <code>amzbelly update</code> no terminal para puxar o novo código.</div>
        ...
        <main class="main-content">
            ...
            <div id="pedidos" class="tab-pane">
                ...
                <div class="pedidos-tabs">
                    ...
                    <button class="pedido-tab-btn" data-pedido-tab="processando">Processando</button>
                ...
                <div class="pedido-tab-content" id="processando">
                    <div class="pedidos-container" id="pedidos-processando-container">
                        <!-- Preenchido por JavaScript -->
                    </div>
                </div>
...
" class="form-control" style="width: 100%; height: 300px; padding: 15px; font-family: 'Courier New', monospace; font-size: 13px; resize: vertical; border: 2px solid rgba(155, 89, 182, 0.3);"></textarea>
                            ...
                            <div class="card-footer">
                                ...
                                <span class="card-sparkline" style="color: var(--chart-2);">
                                    <svg width="70" height="24" viewBox="0 0 70 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 16 L14 12 L28 15 L42 8 L56 10 L70 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    </svg>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <span class="card-sparkline" style="color: var(--chart-1);">
                                    <svg width="70" height="24" viewBox="0 0 70 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 14 L14 11 L28 17 L42 12 L56 10 L70 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    </svg>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <span class="card-sparkline" style="color: var(--chart-3);">
                                    <svg width="70" height="24" viewBox="0 0 70 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 12 L14 14 L28 11 L42 15 L56 13 L70 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    </svg>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <span class="card-sparkline" style="color: var(--chart-5);">
                                    <svg width="70" height="24" viewBox="0 0 70 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 16 L14 11 L28 13 L42 9 L56 11 L70 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    </svg>
                                </span>
                            </div>
                        </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 40px;">
                    ...
                    <div class="chart-container enhanced performance-chart" style="background: linear-gradient(145deg, rgba(0, 0, 0, 0.15), rgba(0, 168, 255, 0.08)); border: 2px solid rgba(0, 168, 255, 0.25); border-radius: var(--radius); padding: 30px; position: relative; overflow: hidden; box-shadow: 0 15px 35px rgba(0, 168, 255, 0.15);">
                        ...
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="background: linear-gradient(145deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)); padding: 15px; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: inset 0 2px 10px rgba(0, 0, 0, 0.2);">
                                <canvas id="chart-mensal" style="max-height: 250px; display: block; filter: drop-shadow(0 4px 15px rgba(0, 168, 255, 0.1));"></canvas>
                            </div>
                    ...
                    <div class="chart-container enhanced" style="background: linear-gradient(145deg, rgba(0, 0, 0, 0.15), rgba(46, 204, 113, 0.08)); border: 2px solid rgba(46, 204, 113, 0.25); border-radius: var(--radius); padding: 18px; position: relative; overflow: hidden;">
                        ...
                        <div style="background: rgba(0, 0, 0, 0.2); padding: 10px; border-radius: 8px;">
                            <canvas id="chart-produtos" style="max-height: 200px; display: block;"></canvas>
                        </div>
                    ...
                    <div style="padding: 30px;">
                        ...
                        <div class="tab-content active" id="analise-mensal">
                            <div style="display: grid; gap: 30px;">
                                ...
                                <div style="background: rgba(0, 0, 0, 0.2); padding: 18px; border-radius: 10px; border: 1px solid rgba(46, 204, 113, 0.2);">
                        ...
                        <div class="tab-content" id="despesas">
                            <div style="display: grid; gap: 30px;">
                                <div style="background: rgba(0, 0, 0, 0.2); padding: 18px; border-radius: 10px; border: 1px solid rgba(231, 76, 60, 0.2);">
            ...
            <div id="automacao" class="tab-pane">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 30px;">
                    <div style="background: rgba(243, 156, 18, 0.15); border: 2px dashed #f39c12; border-radius: var(--radius); padding: 18px;">
                    ...
                    <div style="background: rgba(52, 152, 219, 0.15); border: 2px dashed #3498db; border-radius: var(--radius); padding: 18px;">
            ...
            <div id="integracao" class="tab-pane">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-bottom: 30px;">
                    <div style="background: linear-gradient(135deg, rgba(26, 188, 156, 0.15), rgba(52, 152, 219, 0.08)); border: 2px solid #1abc9c; border-radius: var(--radius); padding: 18px; text-align: center; position: relative; overflow: hidden;">
            ...
            <div id="configuracoes" class="tab-pane">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
                    ...
                    <div style="background: rgba(0, 0, 0, 0.1); border-radius: var(--radius); padding: 25px; border: 1px solid rgba(0, 168, 255, 0.2);">
                        ...
                        <div id="preview-menu" style="background: linear-gradient(135deg, rgba(25, 30, 35, 0.8), rgba(30, 35, 45, 0.8)); border-radius: 10px; padding: 12px; max-height: 350px; overflow-y: auto; border: 1px solid rgba(255, 255, 255, 0.1);">
                            <!-- Preview dinâmico -->
    ...
    <div class="modal-overlay" id="modal-novo-pedido">
        <div class="modal">
            ...
            <div class="modal-tabs">
                <button class="modal-tab-btn active" data-modal-tab="cliente">
                    <span class="aba-indicador">1</span>
                    Cliente
                </button>
                <button class="modal-tab-btn" data-modal-tab="produto">
                    <span class="aba-indicador">2</span>
                    Produto
                </button>
                <button class="modal-tab-btn" data-modal-tab="transporte">
                    <span class="aba-indicador">3</span>
                    Transporte
                </button>
                <button class="modal-tab-btn" data-modal-tab="pagamento">
                    <span class="aba-indicador">4</span>
                    Pagamento
                </button>
            </div>
        ...
        <div class="modal" style="max-width: 700px;">
            <div class="modal-header">
                <div class="modal-title">
                    <i class="fas fa-box" style="margin-right: 10px; color: var(--primary-color);"></i>
                    Novo Produto
                </div>
    ...
    <script>
        ...
        class MarketManager {
            ...
            atualizarCalculoTaxaProduto() {
                ...
                // atualizar lucro e margem no novo display
                const lucroDisplay = document.getElementById('lucro-produto-novo');
                const margemDisplay = document.getElementById('margem-produto-novo');

                if (lucroDisplay && margemDisplay) {
                    if (precoCusto >= 0 && precoVenda >= 0) {
                        const taxaValor = precoVenda * (taxa / 100);
                        const lucroLiquido = precoVenda - precoCusto - taxaValor;
                        const margemCalculada = precoVenda > 0 ? ((lucroLiquido / precoVenda) * 100).toFixed(1) : 0;

                        lucroDisplay.textContent = `R$ ${lucroLiquido.toFixed(2)}`;
                        lucroDisplay.style.color = lucroLiquido >= 0 ? 'var(--success-color)' : 'var(--danger-color)';

                        margemDisplay.textContent = `${margemCalculada}%`;
                        margemDisplay.style.color = 'var(--primary-color)';
                    } else {
                        lucroDisplay.textContent = 'R$ 0.00';
                        margemDisplay.textContent = '0%';
                    }
                }
            }
            ...
            async carregarDadosServidor() {
                try {
                    ...
                    // Ordenar pedidos por data (mais recentes primeiro) para manter a ordem correta da fila
            ...
            gerarSparklineSVG(valores, cor, opts = {}) {
                // opts: { width, height, fill }
                try {
                    if (!Array.isArray(valores) || valores.length === 0) {
                        // placeholder empty SVG
                        return `<svg width="90" height="34" viewBox="0 0 90 34" xmlns="http://www.w3.org/2000/svg"></svg>`;
                    }

                    const largura = opts.width || 140;
                    const altura = opts.height || 48;
                    ...
                    const pontos = valores.map((valor, indice) => {
                        ...
                        const y = altura - ((valor - min) / range) * (altura - 12) - 6;
                        return { x, y };
                    });

                    const pathD = pontos.map((p, i) => `${i === 0 ? 'M' : 'L'} ${p.x.toFixed(2)} ${p.y.toFixed(2)}`).join(' ');

                    // Area fill path (from last point down to bottom and back to first)
                    let areaD = '';
                    if (opts.fill) {
                        areaD = pathD + ` L ${largura} ${altura} L 0 ${altura} Z`;
                    }

                    const strokeColor = cor || 'currentColor';
                    ...
                    return `
                        <svg width="${largura}" height="${altura}" viewBox="0 0 ${largura} ${altura}" xmlns="http://www.w3.org/2000/svg">
                            ...
                            ${opts.fill ? `<path d="${areaD}" fill="url(#${gradientId})" />` : ''}
                            <path d="${pathD}" stroke="${strokeColor}" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none" />
                            <circle cx="${pontos[pontos.length-1].x.toFixed(2)}" cy="${pontos[pontos.length-1].y.toFixed(2)}" r="2.6" fill="${strokeColor}" />
                        </svg>
                    `;
                } catch (e) {
                    console.error('Erro gerarSparklineSVG:', e);
                    return `<svg width="90" height="34" viewBox="0 0 90 34" xmlns="http://www.w3.org/2000/svg"></svg>`;
                }
            }
                        ...
                        <div class="hero-main">
                            <div class="hero-copy">
                                ...
                                <div class="hero-meta">
                                    ...
                                    <span><span class="hero-dot dot-clients"></span>${totalClientes} clientes</span>
                                </div>
                            </div>
                    ...
                    ${cards.map(card => `
                        <div class="card card-kpi ${card.ring ? 'ring-primary-40' : ''}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-mini-chart">${this.gerarSparklineSVG(card.spark, card.sparkColor, {width:140,height:48,fill:true})}</div>
                            </div>
                        </div>
                    `).join('')}
                `;
            ...
            carregarPedidos(filtro = 'todos') {
                ...
                } else if (filtro === 'processando') {
                    pedidosFiltrados = pedidosFiltrados.filter(p => p.rastreio?.status === 'processando');
                ...
                // Ordenar por data (mais recentes primeiro) para manter a ordem correta da fila
                                            ...
                                            <tr data-pedido-id="${pedido.id}">
                                                ...
                                                <td>
                                                    <div style="display: flex; align-items: center; gap: 8px;">
                                                        <span class="dado-sensivel-produto" style="flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 150px;">${pedido.produto?.nome || '-'}</span>
                                                        <button class="btn-expandir-produto" data-pedido-id="${pedido.id}" style="background: none; border: none; cursor: pointer; padding: 4px 8px; color: var(--primary-color); font-size: 16px;" title="Expandir detalhes">
                                                            <i class="fas fa-expand"></i>
                                                        </button>
                                                    </div>
                                                </td>
                                                ...
                                                <td style="color: var(--warning-color); font-weight: 600;">R$ ${precoCusto.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
            ...
            criarContainersPedidos() {
                ...
                // Listener para expandir detalhes do produto
                document.querySelectorAll('.btn-expandir-produto').forEach(btn => {
                    btn.removeEventListener('click', btn._expandirHandler);
                    
                    const expandirHandler = (e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        const pedidoId = parseInt(btn.getAttribute('data-pedido-id'));
                        this.abrirDetailsProduto(pedidoId);
                    };
                    
                    btn._expandirHandler = expandirHandler;
                    btn.addEventListener('click', expandirHandler);
                });
            }

            atualizarContadoresPedidos() {
                const todos = this.pedidos.length;
                const pendentes = this.pedidos.filter(p => p.rastreio?.status === 'pendente').length;
                const processando = this.pedidos.filter(p => p.rastreio?.status === 'processando').length;
                ...
                atualizarBotao('.pedido-tab-btn[data-pedido-tab="processando"]', `Processando (${processando})`);
...
Seu negócio está no caminho certo! Com pequenos ajustes, você pode aumentar a rentabilidade em 25% no próximo trimestre. 🚀`;
                    ...
                    card.innerHTML = `
                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 20px;">
                            <div>
                                ...
                                <div style="background: rgba(70, 180, 255, 0.2); padding: 6px 12px; border-radius: 6px; font-size: 13px; color: var(--primary-color); font-weight: 900; display: inline-block; margin-bottom: 8px;">📋 CPF: <span class="dado-sensivel-cpf">${this.formatarCPFCNPJ(cliente.cpf)}</span></div>
                            </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                            ...
                            <div style="background: rgba(46, 204, 113, 0.1); padding: 20px; border-radius: 10px; border-left: 4px solid #2ecc71;">
                                ...
                                <div style="color: #ecf0f1; line-height: 1.6;">
                                    ...
                                    <strong>CPF:</strong> <span class="dado-sensivel-cpf">${this.formatarCPFCNPJ(cliente.cpf) || 'Não informado'}</span><br>
            ...
            criarFormularioPedido() {
                ...
                form.innerHTML = `
                    <div id="cliente" class="modal-tab-content active">
                        ...
                        <div class="form-group full-width">
                            ...
                            <small>Selecione um produto já cadastrado ou pule para adicionar um novo</small>
                        </div>
                        ...
                        <div class="secao-cliente">
                            <!-- Dados do Pedido -->
                            <div class="sub-secao">
                                <h4><i class="fas fa-shopping-bag"></i> Dados do Pedido</h4>
                                <div class="form-group">
                                    ...
                                    <small>Nome de usuário ou ID da sua conta</small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small>ID único do pedido na plataforma Amazon</small>
                                </div>
                            </div>
                            ...
                            <div class="sub-secao">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pedido-cliente-cpf" placeholder="000.000.000-00" required maxlength="18">
                                    <div id="cpf-feedback" style="margin-top: 5px; font-size: 12px; display: none;"></div>
                                </div>
                        ...
                        <!-- Endereço -->
                        <div class="sub-secao" style="margin-top: 20px;">
                            <h4><i class="fas fa-map-marked-alt"></i> Endereço de Entrega</h4>
                            <div class="form-row">
                                <div class="form-group" style="flex: 0.3;">
                                    <label class="form-label">CEP*</label>
                                    <input type="text" class="form-control" id="pedido-cliente-cep" placeholder="38414-224" required>
                                    <small>Informe o CEP para preencher automaticamente</small>
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <label class="form-label">Link do Mapa</label>
                                    <div style="display: flex; gap: 10px;">
                                        <input type="url" class="form-control" id="pedido-cliente-maps" placeholder="https://maps.app.goo.gl/...">
                                        <button type="button" class="btn btn-secondary" id="btn-gerar-maps">Gerar</button>
                                    </div>
                                    <small>Clique para criar automaticamente</small>
                                </div>
                            </div>
                        </div>

                        <div style="display: flex; justify-content: flex-end; margin-top: 25px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.1);">
                    ...
                    <div id="produto" class="modal-tab-content">
                        <div class="sub-secao" style="margin-bottom: 25px;">
                            <h4><i class="fas fa-info-circle"></i> Informações do Produto</h4>
                            <div class="form-row">
                                <div class="form-group" style="flex: 1.5;">
                                    <label class="form-label">Nome do Produto *</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="pedido-taxa-info" style="color: var(--text-muted);">Taxa: --</small>
                                </div>
                            </div>
                        </div>

                        <div class="sub-secao" style="margin-bottom: 25px;">
                            <h4><i class="fas fa-link"></i> Link de Referência</h4>
                            <div class="form-group full-width">
                                <label class="form-label">URL do Produto *</label>
                                <input type="url" class="form-control" id="pedido-produto-link" placeholder="https://amazon.com.br/produto" required>
                                <small>Link direto para a página do produto na plataforma</small>
                            </div>
                        </div>

                        <div class="sub-secao">
                            <h4><i class="fas fa-calculator"></i> Valores</h4>
                            <div class="form-row">
                                <div class="form-group" style="max-width: 250px;">
                                    <label class="form-label">
                                        <i class="fas fa-tag" style="color: var(--text-muted); font-size: 12px;"></i>
                                        Preço Custo *
                                    </label>
                                    <input type="number" step="0.01" class="form-control" id="pedido-produto-preco-custo" placeholder="0.00" required min="0">
                                    <small>Valor pago para adquirir</small>
                                </div>
                                <div class="form-group" style="max-width: 250px;">
                                    <label class="form-label">
                                        <i class="fas fa-hand-holding-usd" style="color: var(--success-color); font-size: 12px;"></i>
                                        Preço Venda *
                                    </label>
                                    <input type="number" step="0.01" class="form-control" id="pedido-produto-preco-venda" placeholder="0.00" required min="0">
                                    <small>Valor de venda ao cliente</small>
                                </div>
                                <div class="form-group" style="flex: 1; display: flex; align-items: flex-end;">
                                    <div style="background: linear-gradient(145deg, rgba(0, 255, 136, 0.1), rgba(0, 168, 255, 0.1)); border: 1px solid rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; width: 100%;">
                                        <div style="color: var(--text-muted); font-size: 12px; margin-bottom: 5px;">Lucro Estimado</div>
                                        <div id="lucro-estimado" style="font-size: 24px; font-weight: bold; color: var(--success-color);">R$ 0.00</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; justify-content: space-between; margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.1);">
                            ...
                            <button type="button" class="btn btn-secondary btn-proximo" data-proximo="transporte">
                                Próximo: Transporte <i class="fas fa-arrow-right"></i>
                            </button>
                        </div>
                    </div>
                    
                    <div id="transporte" class="modal-tab-content">
                        <div class="secao-cliente">
                            <!-- Rastreamento -->
                            <div class="sub-secao">
                                <h4><i class="fas fa-shipping-fast"></i> Rastreamento</h4>
                                <div class="form-group">
                                    <label class="form-label">Código de Rastreio *</label>
                                    <input type="text" class="form-control" id="pedido-rastreio-codigo" placeholder="NL504095331BR" required maxlength="19">
                                    <small>Formato: 2 letras + 9 números + 2 letras (BR)</small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small>Gerado automaticamente com base no código</small>
                                </div>

                                <div style="background: rgba(255, 193, 7, 0.1); border: 1px solid rgba(255, 193, 7, 0.3); padding: 12px; border-radius: 8px; margin-top: 15px;">
                                    <div style="color: var(--warning-color); font-size: 12px;">
                                        <i class="fas fa-exclamation-triangle" style="margin-right: 5px;"></i>
                                        Importante
                                    </div>
                                    <div style="font-size: 13px; color: var(--text-muted); margin-top: 5px;">
                                        Se o código não estiver disponível, use a ID do pedido temporariamente e atualize depois.
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Status do Pedido -->
                            <div class="sub-secao">
                                <h4><i class="fas fa-clipboard-list"></i> Status do Pedido</h4>
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <small>Use "Atualizar Status" para mudar</small>
                                    </div>
                                </div>
                    ...
                    <div id="pagamento" class="modal-tab-content">
                        <div class="secao-cliente">
                            <!-- Método de Pagamento -->
                            <div class="sub-secao">
                                <h4><i class="fas fa-credit-card"></i> Detalhes do Pagamento</h4>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="pedido-data-pagamento" value="${hoje}">
                                    <small>Data em que o pagamento foi confirmado</small>
                                </div>
                            </div>
                            ...
                            <div class="sub-secao">
                                ...
                                <div style="background: linear-gradient(145deg, rgba(0, 255, 136, 0.1), rgba(0, 168, 255, 0.1)); border: 1px solid rgba(255,255,255,0.1); padding: 20px; border-radius: 8px;">
                                    <div style="margin-bottom: 15px;">
                                        <div style="color: var(--text-muted); font-size: 12px; margin-bottom: 5px;">Produto</div>
                                        <div id="resumo-produto" style="font-size: 16px; font-weight: 600;">--</div>
                                    </div>
                                    <div style="margin-bottom: 15px;">
                                        <div style="color: var(--text-muted); font-size: 12px; margin-bottom: 5px;">Cliente</div>
                                        <div id="resumo-cliente" style="font-size: 14px;">--</div>
                                    </div>
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 15px;">
                                        <div>
                                            <div style="color: var(--text-muted); font-size: 12px; margin-bottom: 5px;">Custo</div>
                                            <div id="resumo-custo" style="font-size: 18px; font-weight: 600;">R$ --</div>
                                        </div>
                                        <div>
                                            <div style="color: var(--text-muted); font-size: 12px; margin-bottom: 5px;">Venda</div>
                                            <div id="resumo-venda" style="font-size: 18px; font-weight: 600; color: var(--success-color);">R$ --</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="sub-secao" style="margin-top: 20px;">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="pedido-observacoes" placeholder="Adicione informações adicionais sobre este pedido..." rows="3"></textarea>
                                <small>Informações importantes que possam ajudar no futuro</small>
                            </div>
                        </div>
                        
                        <div style="display: flex; justify-content: space-between; margin-top: 30px;">
                            <button type="button" class="btn btn-voltar" data-voltar="transporte">
                                <i class="fas fa-arrow-left"></i> Voltar
                            </button>
                ...
                const cpfInput = document.getElementById('pedido-cliente-cpf');
                ...
                cpfInput.addEventListener('input', (e) => {
                    ...
                    // Validar e mostrar feedback
                    const numerosLimpos = e.target.value.replace(/\D/g, '');
                    ...
                    } else if (numerosLimpos.length <= 11) {
                        const restantes = 11 - numerosLimpos.length;
                        if (numerosLimpos.length === 11) {
                            if (validarCPF(e.target.value)) {
                                cpfFeedback.innerHTML = '<span class="valido">✓ CPF válido</span>';
                                cpfInput.classList.add('valido');
                            } else {
                                cpfFeedback.innerHTML = '<span class="invalido">✗ CPF inválido</span>';
                                cpfInput.classList.add('invalido');
                            }
                        } else {
                            cpfFeedback.innerHTML = `<span class="pendente">Faltam ${restantes} dígitos para CPF</span>`;
                        }
                    } else {
                        const restantes = 14 - numerosLimpos.length;
                        if (numerosLimpos.length === 14) {
                            if (validarCNPJ(e.target.value)) {
                                cpfFeedback.innerHTML = '<span class="valido">✓ CNPJ válido</span>';
                                cpfInput.classList.add('valido');
                            } else {
                                cpfFeedback.innerHTML = '<span class="invalido">✗ CNPJ inválido</span>';
                                cpfInput.classList.add('invalido');
                            }
                        } else {
                            cpfFeedback.innerHTML = `<span class="pendente">Faltam ${restantes} dígitos para CNPJ</span>`;
                        }
                    }
                });
                ...
                this.atualizarResumoPedido = () => {
                    const nomeProduto = document.getElementById('pedido-produto-nome')?.value || '--';
                    const nomeCliente = document.getElementById('pedido-cliente-nome')?.value || '--';
                    const precoCusto = document.getElementById('pedido-produto-preco-custo')?.value || '0';
                    const precoVenda = document.getElementById('pedido-produto-preco-venda')?.value || '0';

                    // Atualizar resumo
                    const resumoProduto = document.getElementById('resumo-produto');
                    if (resumoProduto) resumoProduto.textContent = nomeProduto;

                    const resumoCliente = document.getElementById('resumo-cliente');
                    if (resumoCliente) {
                        const cpf = document.getElementById('pedido-cliente-cpf')?.value || '';
                        resumoCliente.textContent = `${nomeCliente}${cpf ? ' - ' + cpf : ''}`;
                    }

                    const resumoCusto = document.getElementById('resumo-custo');
                    if (resumoCusto) resumoCusto.textContent = `R$ ${parseFloat(precoCusto).toFixed(2)}`;

                    const resumoVenda = document.getElementById('resumo-venda');
                    if (resumoVenda) resumoVenda.textContent = `R$ ${parseFloat(precoVenda).toFixed(2)}`;

                    // Atualizar lucro estimado na aba produto
                    const lucroEstimado = document.getElementById('lucro-estimado');
                    if (lucroEstimado) {
                        const lucro = parseFloat(precoVenda) - parseFloat(precoCusto);
                        lucroEstimado.textContent = `R$ ${lucro.toFixed(2)}`;
                        lucroEstimado.style.color = lucro >= 0 ? 'var(--success-color)' : 'var(--danger-color)';
                    }
                };
                ...
                const inputsParaMonitorar = [
                    ...
                    'pedido-cliente-nome',
                    'pedido-cliente-cpf',
                    'pedido-produto-preco-custo',
                    'pedido-produto-preco-venda',
                    'pedido-produto-existente'
                ];

                inputsParaMonitorar.forEach(id => {
                    const elemento = document.getElementById(id);
                    if (elemento) {
                        elemento.addEventListener('input', () => this.atualizarResumoPedido());
                        elemento.addEventListener('change', () => this.atualizarResumoPedido());
                        elemento.addEventListener('blur', () => this.atualizarResumoPedido());
                    }
                });
                ...
                // Adicionar listener para mudança de produto existente
                document.getElementById('pedido-produto-existente').addEventListener('change', (e) => {
                    const produtoId = e.target.value;
                    if (produtoId && this.produtos.length > 0) {
                        const produto = this.produtos.find(p => p.id === produtoId);
                        if (produto) {
                            // Preencher campos com dados do produto selecionado
                            document.getElementById('pedido-produto-nome').value = produto.nome || '';
                            document.getElementById('pedido-produto-categoria').value = produto.categoria || '';
                            document.getElementById('pedido-produto-link').value = produto.link || '';
                            document.getElementById('pedido-produto-preco-custo').value = produto.precoCusto || '';
                            document.getElementById('pedido-produto-preco-venda').value = produto.precoVenda || '';
                            this.atualizarResumoPedido();
            ...
            criarFormularioProduto() {
                ...
                form.innerHTML = `
                    ...
                    <div class="sub-secao" style="margin-bottom: 25px;">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <small id="produto-taxa-info" style="color: var(--text-muted);">Taxa: --</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="secao-cliente">
                        ...
                        <div class="sub-secao">
                            ...
                            <div class="form-group">
                                ...
                                <small>Plataforma principal de venda</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <small>URL direta para a página do produto</small>
                            </div>
                        </div>

                        <!-- Valores e Estoque -->
                        <div class="sub-secao">
                            <h4><i class="fas fa-calculator"></i> Valores e Estoque</h4>
                            <div class="form-row">
                                ...
                                <div class="form-group" style="max-width: 200px;">
                                    ...
                                    <small>Preço ao cliente</small>
                                </div>
                                <div class="form-group" style="max-width: 200px;">
                                    <label class="form-label">
                                        <i class="fas fa-boxes" style="color: var(--primary-color); font-size: 12px;"></i>
                                        Estoque
                                    </label>
                                    <input type="number" class="form-control" id="produto-estoque-novo" placeholder="0" min="0" value="0">
                                    <small>Qtd em estoque</small>
                                </div>
                            </div>

                            <div style="background: linear-gradient(145deg, rgba(0, 255, 136, 0.1), rgba(0, 168, 255, 0.1)); border: 1px solid rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; margin-top: 15px;">
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                    <div>
                                        <div style="color: var(--text-muted); font-size: 12px; margin-bottom: 5px;">Lucro por Unidade</div>
                                        <div id="lucro-produto-novo" style="font-size: 24px; font-weight: bold; color: var(--success-color);">R$ 0.00</div>
                                    </div>
                                    <div>
                                        <div style="color: var(--text-muted); font-size: 12px; margin-bottom: 5px;">Margem de Lucro</div>
                                        <div id="margem-produto-novo" style="font-size: 24px; font-weight: bold; color: var(--primary-color);">0%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Descrição -->
                    <div class="sub-secao" style="margin-bottom: 30px;">
                        <h4><i class="fas fa-align-left"></i> Descrição do Produto</h4>
                        <div class="form-group">
                            <textarea class="form-control" id="produto-descricao-novo" rows="4" placeholder="Descreva o produto com suas características principais, especificações técnicas, vantagens, etc."></textarea>
                            <small>Detalhes importantes sobre o produto que ajudarão na venda</small>
                        </div>
                    </div>
            ...
            validarAbaPedido(abaId) {
                ...
                if (abaId === 'cliente') {
                    ...
                    const numeros = cpfValor?.replace(/\D/g, '');

                    if (!numeros || numeros.length === 0) {
                        this.marcarCampoInvalido(cpfInput);
                        this.mostrarNotificacao('Preencha o CPF ou CNPJ.', 'warning');
                        return false;
                    }

                    // Verificar se todos os números são iguais (CPF inválido)
                    if (numeros.length === 11 && /^(\d)\1+$/.test(numeros)) {
                        this.marcarCampoInvalido(cpfInput);
                        this.mostrarNotificacao('CPF inválido: não pode ter todos os números iguais.', 'warning');
                        return false;
                    }

                    // Verificar se todos os números são iguais (CNPJ inválido)
                    if (numeros.length === 14 && /^(\d)\1+$/.test(numeros)) {
                        this.marcarCampoInvalido(cpfInput);
                        this.mostrarNotificacao('CNPJ inválido: não pode ter todos os números iguais.', 'warning');
                        return false;
                    }
                    ...
                    if (numeros.length === 11) {
                        ...
                        if (digito1 !== parseInt(numeros[9]) || digito2 !== parseInt(numeros[10])) {
                            this.marcarCampoInvalido(cpfInput);
                            this.mostrarNotificacao('CPF inválido. Verifique os dígitos.', 'warning');
                            return false;
                        }
                    }
                    ...
                    if (numeros.length === 14) {
                        ...
                        if (digito1 !== parseInt(numeros[12]) || digito2 !== parseInt(numeros[13])) {
                            this.marcarCampoInvalido(cpfInput);
                            this.mostrarNotificacao('CNPJ inválido. Verifique os dígitos.', 'warning');
                            return false;
                        }
                    }
                }
            ...
            abrirDetailsProduto(pedidoId) {
                ...
                // Criar ou atualizar o sidepanel
                ...
                if (!sidepanel) {
                    ...
                    overlay.className = 'sidepanel-overlay';
                    document.body.appendChild(overlay);

                    overlay.addEventListener('click', () => this.fecharDetailsProduto());
                }

                // Preencher o conteúdo do sidepanel
                sidepanel.innerHTML = `
                    <div class="sidepanel-header">
                        <div class="sidepanel-title">Detalhes do Produto</div>
                        <button class="sidepanel-close" onclick="window.marketManager.fecharDetailsProduto()">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
                    <div class="sidepanel-content">
                        <div class="sidepanel-field">
                            <span class="sidepanel-label">Nome do Produto</span>
                            <div class="sidepanel-value">${produto.nome || '-'}</div>
                        </div>

                        <div class="sidepanel-field">
                            <span class="sidepanel-label">Categoria</span>
                            <div class="sidepanel-value">${categoria || '-'}</div>
                        </div>

                        <div class="sidepanel-field">
                            <span class="sidepanel-label">Link do Produto</span>
                            <div class="sidepanel-value">
                                ${produto.link ? `<a href="${produto.link}" target="_blank" style="color: var(--primary-color); text-decoration: none;">Abrir Link <i class="fas fa-external-link-alt"></i></a>` : '-'}
                            </div>
                        </div>

                        <div class="sidepanel-divider"></div>

                        <div class="sidepanel-field">
                            <span class="sidepanel-label">Preço de Venda</span>
                            <div class="sidepanel-value" style="color: var(--success-color); font-weight: 600;">
                                R$ ${precoVenda.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                            </div>
                        </div>

                        <div class="sidepanel-field">
                            <span class="sidepanel-label">💰 Valor Gasto (Custo)</span>
                            <div class="sidepanel-value" style="color: var(--warning-color); font-weight: 600; border-left-color: var(--warning-color);">
                                R$ ${precoCusto.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                            </div>
                        </div>

                        <div class="sidepanel-field">
                            <span class="sidepanel-label">Taxa de Plataforma (${taxaCategoria}%)</span>
                            <div class="sidepanel-value">
                                R$ ${feeAmount.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                            </div>
                        </div>
                        ...
                        <div class="sidepanel-field">
                            <span class="sidepanel-label">Lucro Líquido</span>
                            <div class="sidepanel-value" style="color: ${lucro >= 0 ? 'var(--success-color)' : 'var(--danger-color)'}; font-weight: 600; border-left-color: ${lucro >= 0 ? 'var(--success-color)' : 'var(--danger-color)'};">
                                R$ ${lucro.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                            </div>
                        </div>
                        ...
                        ${produto.estoque !== undefined ? `
                            <div class="sidepanel-field">
                                <span class="sidepanel-label">Estoque</span>
                                <div class="sidepanel-value">${produto.estoque} unidades</div>
                            </div>
                        ` : ''}
                        ...
                        ${produto.descricao ? `
                            <div class="sidepanel-divider"></div>
                            <div class="sidepanel-field">
                                <span class="sidepanel-label">Descrição</span>
                                <div class="sidepanel-value" style="line-height: 1.5;">
                                    ${produto.descricao}
                                </div>
                            </div>
                        ` : ''}
            ...
            async editarPedido(id) {
                ...
                setTimeout(() => {
                    ...
                    // Atualizar o resumo do pedido com os valores carregados
                    setTimeout(() => {
                        if (this.atualizarResumoPedido) {
                            this.atualizarResumoPedido();
                        }
                    }, 200);

                    // Adicionar listeners diretos para garantir atualização em tempo real na edição
                    const inputsAtualizacao = ['pedido-produto-preco-custo', 'pedido-produto-preco-venda'];
                    inputsAtualizacao.forEach(id => {
                        const elemento = document.getElementById(id);
                        if (elemento) {
                            // Remover listeners anteriores para evitar duplicação
                            elemento.removeEventListener('input', this.atualizarResumoPedido);
                            const boundFunc = this.atualizarResumoPedido.bind(this);
                            elemento.addEventListener('input', boundFunc);
                        }
                    });
            ...
            async editarProduto(id) {
                ...
                setTimeout(() => {
                    ...
                    // Atualizar o cálculo de lucro e margem com os valores carregados
                    setTimeout(() => {
                        if(this.atualizarCalculoTaxaProduto) {
                            this.atualizarCalculoTaxaProduto();
                        }
                    }, 200);

                    // Adicionar listeners diretos para garantir atualização em tempo real na edição
                    const inputsProduto = ['produto-preco-custo-novo', 'produto-preco-venda-novo'];
                    inputsProduto.forEach(id => {
                        const elemento = document.getElementById(id);
                        if (elemento) {
            ...
            carregarAnaliseFinanceira() {
                ...
                if (cardContainer) {
                    cardContainer.innerHTML = `
                        <div class="card">
                            ...
                            <div class="card-mini-chart">
                                <canvas id="chart-faturamento-card" width="240" height="60"></canvas>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-mini-chart">
                                <canvas id="chart-lucro-card" width="240" height="60"></canvas>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-mini-chart">
                                <canvas id="chart-lucro-sem-taxas-card" width="240" height="60"></canvas>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-mini-chart">
                                <canvas id="chart-custo-total-card" width="240" height="60"></canvas>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-mini-chart">
                                <canvas id="chart-margem-card" width="240" height="60"></canvas>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-mini-chart">
                                <canvas id="chart-custos-detalhado-card" width="240" height="60"></canvas>
                            </div>
                    ...
                    // Renderizar gráficos nos cards
                    this.renderizarGraficosCards();
                }
                ...
                container.innerHTML = `
                    <div style="margin-bottom: 40px;">
                        ...
                        <div style="background: rgba(0, 0, 0, 0.2); padding: 25px; border-radius: var(--radius); border: 1px solid rgba(155, 89, 182, 0.15);">
                            <canvas id="chart-produtos" style="max-height: 280px;"></canvas>
                        </div>
                    </div>
